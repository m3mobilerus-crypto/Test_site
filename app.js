...
btnAdd.style.cssText='flex:1;justify-content:center;';
...
// Stock button for accessory
const btnStock=$$('button');
btnStock.className='sku-stock-btn';
btnStock.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/><line x1="12" y1="12" x2="12" y2="16"/><line x1="10" y1="14" x2="14" y2="14"/></svg>Наличие';
btnStock.addEventListener('click',(e)=>showInlineStock(e, acc.sku));
actionsDiv.appendChild(btnStock);
